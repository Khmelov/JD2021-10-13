...
public class ListB<T> implements List<T> {
    ...
    public T get(int index) {
        ...
        System.out.println("Error: Incorrect index. (ArrayOutOfBoundException, GET ;)");
        return null;
    }
    ...
    public T remove(int index) {
        ...
        System.out.println("Error: Incorrect index. (ArrayOutOfBoundException, REMOVE ;)");
        return null;
    }
    ...
    public T set(int index, T element) {
        ...
        System.out.println("Error: Incorrect index. (ArrayOutOfBoundException, SET ;)");
        return null;
    }
    ...
    public void add(int index, T element) {
        if (index <= size && index > -1) {
            ...
            System.out.println("Error: Incorrect index. (ArrayOutOfBoundException, ADD ;)");
        }
    }
