...
import by.it.marukovich.jd02_03.model.Casheir;
import by.it.marukovich.jd02_03.model.Customer;
import by.it.marukovich.jd02_03.model.Store;
...
public class StoreWorker extends Thread {
    ...
    public void start() {
        ...
        for (int numberCashier = 1; numberCashier <= 2; numberCashier++) {
            Casheir casheir = new Casheir(numberCashier);
