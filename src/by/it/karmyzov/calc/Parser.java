...
class Parser {
    ...
    private Var calcOneOperation(String leftPart, String operation, String rightPart) throws CalcExeption {
        Var right = varCreator.createVar(rightPart);
        if (Objects.isNull(right)) {
            throw new CalcExeption("Incorrect variable" + rightPart);
        }
        if (operation.equals("=")) {
        ...
        throw new CalcExeption("Somethimg Wrong");
    }
